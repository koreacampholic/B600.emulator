...
public class MyWBWRenderer extends SWTPartRenderer {
	...
	public void init() {
		topWindowHandler = new EventHandler() {
			...
			public void handleEvent(Event event) {
				...
				if (!(win.getRenderer() == MyWBWRenderer.this))
					return;
		...
		shellUpdater = new EventHandler() {
			public void handleEvent(Event event) {
				...
				if (windowModel.getRenderer() != MyWBWRenderer.this)
					return;
